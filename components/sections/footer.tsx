...
export default function Footer(){
  ...
  return(
    <div id="footer" className="">
      <footer className="bg-gray-100 pt-12 relative bg-cover bg-center z-0 " style={{backgroundImage:"url(https://res.cloudinary.com/dh3h0lhyh/image/upload/v1718550846/casaestal/wzjmbaxsd2gpr0fybafe.jpg)"}}>
            ...
            <div className="container mx-auto px-4 bg-white z-10">
                <div className="flex flex-col md:flex-row justify-between items-center mt-8 z-10">
                    <div className="text-gray-600">
                      <h2 className='text-xl leading-10'>Casa Estal</h2>
                      <p className='text-xs'>Experience the ultimate urban retreat at Casa Estal Staycation. Our luxurious condos in Makati City and Santa Mesa, Manila, offer modern amenities, stylish interiors, and convenient access to vibrant city attractions. Perfect for both leisure and business travelers seeking comfort and sophistication.</p>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center z-10 mt-7 text-xs">
                    <div className="flex gap-x-7 items-center z-10 ml-0">
                        <p className="text-gray-600">© Casa Estal. All Rights Reserved { formatDate(Date(),'yyyy' )}</p>
